<style>
    ...
    <div class="container mt-5 form-container">
        <h2 class="text-center">Update New Type</h2>
        <form method="get"action="">
            <div class="mb-3">
                <label for="typeId" class="form-label">Type ID</label>
                <input type="text" class="form-control-plaintext" id="typeId" name="typeId" value="<?php echo $type->id;?>">
            </div>
            <div class="mb-3">
                <label for="typeName" class="form-label">Type</label>
                <input type="text" class="form-control" id="typeName" name="typeName" value="<?php echo $type->name;?>"required>
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Price</label>
                <input type="text" class="form-control" id="price" name="price" value="<?php echo $type->price;?>"required>
            </div>
            <input type="hidden" name="controller" value="type"/>               
            <button type="submit" class="btn-add me-2" name="action" value="update">Update Type</button>
